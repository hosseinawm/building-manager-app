...
const buildingHero = '/assets/images/home/hero2.jpg';
      ...
      <Grid container justifyContent="space-between" alignItems="center" sx={{ mt: { xs: 10, sm: 6, md: 18.75 }, mb: { xs: 2.5, md: 10 } }}>
            ...
            <Grid item xs={12}>
              ...
              >
                <Grid container spacing={2} sx={{ justifyContent: { xs: 'center', md: 'flex-start' } }}>
                  <Grid item>
                    <AnimateButton>
                      <Button component={Link} href={DASHBOARD_PATH} target="_blank" size="large" variant="outlined" color="secondary">
                        ورود به برنامه
                      </Button>
                    </AnimateButton>
                  </Grid>
        ...
        <Grid item xs={12} md={7} sx={{ display: { xs: 'none', md: 'flex' } }}>
          <Box sx={{ position: 'relative', mt: 8.75, zIndex: 9 }}>
            <HeaderImage src={buildingHero} alt="Berry" />
            {/* <Box
              sx={{
                position: 'absolute',
                top: { md: -35, lg: -110 },
