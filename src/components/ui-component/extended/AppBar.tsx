        ...
        <Container>
          <Toolbar sx={{ py: 2.5, px: `0 !important` }}>
            ...
            <Stack direction="row" sx={{ display: { xs: 'none', sm: 'block' } }} spacing={{ xs: 1.5, md: 2.5 }}>
              ...
              <Button component={Link} href="panel" target="_blank" disableElevation variant="contained" color="secondary">
                ورود به برنامه
              </Button>
            </Stack>
                ...
                {drawerToggle && (
                  <Box sx={{ width: 'auto' }} role="presentation" onClick={drawerToggler(false)} onKeyDown={drawerToggler(false)}>
                    <List>
                      ...
                      <Link style={{ textDecoration: 'none' }} href="panel" target="_blank">
                        <ListItemButton component="a">
                          <ListItemIcon>
                            <IconCreditCard />
                          </ListItemIcon>
                          <ListItemText primary="ورود به برنامه" />
                        </ListItemButton>
                      </Link>
                    </List>
                  </Box>
